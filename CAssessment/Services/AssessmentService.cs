...
public class AssessmentService(DataContext dContext, CourseService courses)
{
    ...
    public Course? DisplayStudentScoreSheet(Student student)
    {
        ...
        var table = new TableView<CourseMarkViewModel>(columnNames, courseMarks, title);
    ...
    public void DisplayCourseSheet()
    {
        ...
        var title = $"Course Sheet: {course}";
        var table = new TableView<StudentMarkViewModel>(columnNames, marks, title);
