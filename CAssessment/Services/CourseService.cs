...
public class CourseService(DataContext dContext)
{
    ...
    private int DrawCourseTable(List<Course>? cources = null, string title = "All Courses")
    {
        ...
        List<string> columnNames = ["Id", "Code", "Title", "Credit Hours"];
        var table = new TableView<Course>(columnNames, cources, title);
        table.Align(3, ColumnAlign.Right);
        return table.Render();
    }
    ...
    private Menu CreateMenu()
    {
        ...
        return new Menu(list, "Courses Portal");
    }
}
