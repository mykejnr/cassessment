...
public class StudentService(DataContext dContext, CourseService courses, AssessmentService assessments)
{
    ...
    {
        List<string> columnNames = ["Id", "Surname", "Other Names", "Date of Birth"];
        var table = new TableView<Student>(columnNames, dContext.Students);
        return table.Render();
    }
    ...
    private Menu CreateMenu()
    {
        ...
        return new Menu(list, "Students Portal");
    }
}
